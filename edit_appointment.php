...
<body>
    ...
    if (isset($_GET['id'])) {
        $client = $client->get_appointment_id($_GET['id']);
    }
    ...
    <form method="post" action="">
        ...
        <input type="number" name="numriTel" value="<?php echo $client->getNumriTel(); ?>" required>
        <br>
        <br>
        <button name="app">Edit Appointment!</button>
    </form>
